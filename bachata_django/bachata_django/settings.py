"""
Django settings for bachata_django project.
...
ALLOWED_HOSTS = ['salsaevents.herokuapp.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'bachata_django.urls'
...
WSGI_APPLICATION = 'bachata_django.wsgi.application'
